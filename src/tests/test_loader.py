...
class TestLoader(unittest.TestCase):
    ...
    def _get_cfg(self, uid):
        ...
        """
        cfg = {"code": get_sample_code(random.randint(1, 5) * 2)}
    ...
    def test_unique_id_specified(self):
        ...
        for _ in range(20):
            ...
            self.assertEqual(
                loader.unique_id, name, "Unique ID should equal the specified one"
            )
    ...
    def test_prepare_code(self):
        ...
        for _ in range(20):
            ...
            indentation_after = detect_indentation(
                loader._code
            )  # pylint: disable=protected-access
            ...
            self.assertEqual(
                indentation_before, indentation_after, "Indentation cannot be modified"
            )
    ...
    def test_create_module(self):
        ...
        for _ in range(20):
            ...
            self.assertTrue(
                os.path.isfile(loader.module_path), "Python file should be created"
            )
