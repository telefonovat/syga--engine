...
class TestColor(unittest.TestCase):
    ...
    def test_is_rgba_int_valid(self):
        ...
        for _ in range(500):
            ...
            self.assertTrue(
                Color.is_rgba(color_rgba_str), "{} is valid".format(color_rgba_str)
            )
    ...
    def test_is_rgba_invalid(self):
        ...
        for _ in range(500):
            ...
            self.assertFalse(
                Color.is_rgba(color_rgba_str), f"{color_rgba_str} is invalid"
            )
    ...
    def test_normalize_hex_long(self):
        ...
        for _ in range(500):
            ...
            color_hex = "#{}".format(
                "".join(["%02x" % round(c * 255) for c in color_rgba])
            )
    ...
    def test_normalize_rgba_int(self):
        ...
        for _ in range(500):
            ...
            for actual, expected in zip(
                Color.normalize_color(color_rgba_str), color_rgba
            ):
    ...
    def test_to_hex(self):
        ...
        for _ in range(500):
            ...
            self.assertEqual(
                hex_color,
                conversion,
                f"Original: {hex_color} != Coverted: {conversion}",
            )
